...
//		스캐너로 입력받을 때 아래와 같이 trim() 메서드를 붙여주면 데이터를 입력받자마자 불필요한 빈 칸을 제거한 후 변수에 저장한다.
...
//		toUpperCase() 메서드는 영문자를 무조건 대문자로 변환하고
//		toLowerCase() 메서드는 영문자를 무조건 소문자로 변환한다.
...
//		키보드로 1문자만 입력받기
//		System.out.println("문자를 입력하세요.(1문자만 입력) : ");
